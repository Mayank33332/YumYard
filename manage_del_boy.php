...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_num_rows(mysqli_query($con,"select * from del_boy where mobile='$mobile'"))> 0) {

    $msg="this delivery boy already exist";
  ...
  else
  {
    ...
    mysqli_query($con,"insert into del_boy(name,password,mobile,status,added_on) values('$name','$password','$mobile',1,'$added_on')");
  ...
  if(isset($_GET['id']) && $_GET['id']>0){
    ...
    $row=mysqli_fetch_assoc(mysqli_query($con,"select * from del_boy where id='$id'"));
