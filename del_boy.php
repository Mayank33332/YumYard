...
$sql = "select * from del_boy order by id desc";
...
if (isset($_GET['type']) && ($_GET['type'] != '') && isset($_GET['id']) && ($_GET['id'] > 0)) {
    ...
    if ($type == 'active' || ($type == 'deactive')) {
        ...
        mysqli_query($con, "update del_boy set status='$status'  where id='$id'");
        redirect("del_boy.php");
    }
}
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="card-title">delivery boy master</h1>
                            <a href="manage_del_boy.php" class="h2">Add delivery boy</a>
                            <div class="row">
                                <div class="col-12">
                                                ...
                                                <?php if (mysqli_num_rows($res) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 <a href="manage_del_boy.php?id=<?php echo $row['id'] ?>"><label class="badge badge-success p12 cursor">Edit</label></a>
                                                                <?php
                                                                if($row['status'] == 1) { ?>
                                                                    <a href="?id=<?php echo $row['id'] ?> &type=deactive"><label
                                                                            class="badge badge-danger p12 cursor">active</label></a>
                                                                <?php } else {
